...
jQuery(document).ready(function($) {
    $( ".accordion" ).accordion({
      header: ".accordiontoggle", // Selector for the header element / toggle
	  heightStyle: "content", // Controls the height of the accordion and each panel
	  active: false, // Setting active to false will collapse all panels. This requires the collapsible option to be true
